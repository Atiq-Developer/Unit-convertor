...
export default function UnitConverter() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-blue-900 dark:bg-gray-900">
      {/* Center the unit converter card within the screen */}
      <div className="max-w-md w-full p-6 bg-card rounded-lg shadow-lg bg-gray-300">
        ...
        <div className="mt-6 text-center">
          ...
          <div className="text-muted-foreground text-black font-bold">
